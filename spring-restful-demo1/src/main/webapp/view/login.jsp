...
<body>
	<div id="login">
		<div id="login_header">
			<h1 class="login_logo">
				<a href="£"><img src="<%=request.getContextPath()%>/static/dwz/themes/default/images/login_logo.gif" /></a>
			</h1>
			<div class="login_headerContent">
				...
				<h2 class="login_title"><img src="<%=request.getContextPath()%>/static/dwz/themes/default/images/login_title.png" /></h2>
			</div>
		</div>
		<div id="login_content">
			<div class="loginForm">
				<!-- <form action="index.html"> -->
					...
					<div class="login_bar">
						<input class="sub" type="botton" id="loginBtn" value="" />
					</div>
				<!-- </form> -->
			</div>
			<div class="login_banner"><img src="<%=request.getContextPath()%>/static/dwz/themes/default/images/login_banner.jpg" /></div>
